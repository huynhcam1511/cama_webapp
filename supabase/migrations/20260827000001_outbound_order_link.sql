...
CREATE INDEX IF NOT EXISTS idx_inventory_outbound_sessions_order_id
ON public.inventory_outbound_sessions(order_id);
...
BEGIN
    ...
    INSERT INTO public.inventory_outbound_sessions
        (staff_id, reason, order_id, contract_id, notes, total_quantity)
    VALUES
        (v_staff_id, v_reason, v_order_id, v_contract_id, v_notes, v_total)
